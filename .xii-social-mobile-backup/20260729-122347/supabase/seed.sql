-- XII SOCIAL Ultra Premium — Seed data
...
insert into public.site_settings (
  ...
  'XII SOCIAL — Official Class Website', 'XII SOCIAL', 'WELCOME XII SOCIAL',
  'Bersama tumbuh, bersama mengukir cerita.', 'Angkatan 2026',
  'Ruang digital untuk menyimpan cerita, karya, persahabatan, dan kenangan terbaik keluarga XII SOCIAL.',
  './assets/defaults/default-logo.webp',
  'Terima kasih telah menjadi bagian dari XII SOCIAL.',
...
insert into public.about (id,history,vision,mission,goals,expectations,achievements,quote) values (
  ...
  'XII SOCIAL adalah keluarga belajar yang tumbuh melalui kerja sama, keberanian, dan kepedulian.',
...
('00000000-0000-4000-8000-000000000004','Tentang XII SOCIAL','Struktur Organisasi XII SOCIAL','Anggota XII SOCIAL','Galeri Kenangan')
...
('Nama Wali Kelas','Wali Kelas','Pembimbing dan pengarah keluarga XII SOCIAL.','./assets/defaults/default-avatar.webp',1),
...
select n,
  ...
  'Kota Kelahiran',
  'anggota' || lpad(n::text,2,'0'),
  'Salah satu bagian penting dari keluarga XII SOCIAL.',
